...
| `WHATSAPP_UTILITY_MSG_COST_USD` | — | `0.0` | Estimated per-message cost (USD) of a paid (out-of-window) utility template send. Display-only — used by the admin Send Templates console to estimate broadcast cost. Not billed or enforced. |

        ...
        <p className="mb-3 text-xs leading-relaxed text-gray-500 dark:text-gray-400">
          {mode === "max" ? (
            ...
            <>
              ...
              counts members who registered, confirmed via WhatsApp, or were set by an admin — arrival-date-only defaults are excluded.
              Use this to see who has actively confirmed.
            </>
          )}{" "}

...
<data-model>
General guidance:
- Milestones are major deliverables, budget lines, or tangible items that a department is working toward. Examples: website ready for private review, AI helpdesk launched, site electrical plan completed, mawaid seating plan finalized. They usually have budgets associated. Milestones need to be MECE. We do not want overlapping milestones.
...
- title: Required short name of the milestone.  Keep them short.
...
<transcript-type>
This upload is a meeting transcript or meeting minutes. Actual event dates are June 15-24 2026.  Use the meeting date as context for relative due dates like "tomorrow", "next week", or "before waaz" when the transcript gives enough context.
</transcript-type>

${FUNCTION_CALL_SCHEMA_SECTION}`;

const defaultPrompt =
  "Focus on reviewable milestones, tasks and issues. Major items the team is working towards with budget involved are their milestones. Convert unresolved operational questions into issues when they block progress. Convert accepted requests into task updates.";
...
const meetingPromptSuffix =
  "For meeting transcripts, treat follow-ups without owners as tasks with assigned_to_alias null.";
